...
export async function registerRoutes(server: ReturnType<typeof createServer>, app: Express) {
  ...
  // ==================== FX STUDIO API ROUTES (pscomixx.online sync) ====================
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">`;
  ...
  app.get("/api/legal/privacy-policy", (_req, res) => {
    res.json({
      ...
      content: {
        ...
        contact: "For privacy inquiries: privacy@pscomixx.com | For school/district data requests: districts@pscomixx.com | For COPPA-related requests: coppa@pscomixx.com | MADMixedMedia LLC | Ecosystem platforms: pscomixx.com, pscomixx.online, psstreaming.com, pressstart.tech"
      }
    });
  });
  ...
  app.get("/api/legal/dpa", (_req, res) => {
    res.json({
      ...
      lastUpdated: "2026-03-21",
      content: {
        purpose: "This Data Processing Agreement (\"DPA\") supplements the Terms of Service and applies when any platform within the MADMixedMedia Ecosystem processes Student Education Records on behalf of a School or School District (\"Institution\"). The Ecosystem includes Press Start CoMiXX (pscomixx.com, pscomixx.com, comixx.website, pscomixx.online), PressPlays / FX Studio (pscomixx.online), PS Streaming / Mad Mixed Media (psstreaming.com, psstreaming.online), Press Start LMS (pressstart.tech), and any successor or affiliated platforms. This DPA governs the processing of Student Education Records across all Ecosystem platforms authorized by the Institution for student use.",
        definitions: {
