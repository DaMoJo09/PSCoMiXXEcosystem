...
const LEVEL_THRESHOLDS: { level: number; xp: number; title: string }[] = [
  ...
  { level: 6, xp: 1000, title: "Builder" },
  { level: 7, xp: 1400, title: "Artisan" },
  { level: 8, xp: 1900, title: "Craftsman" },
  { level: 9, xp: 2500, title: "Innovator" },
  { level: 10, xp: 3200, title: "Visionary" },
  { level: 11, xp: 4000, title: "Expert" },
  { level: 12, xp: 5000, title: "Master" },
  { level: 13, xp: 6200, title: "Virtuoso" },
  { level: 14, xp: 7600, title: "Legend" },
  { level: 15, xp: 9200, title: "Mythic" },
  { level: 16, xp: 11000, title: "Titan" },
  { level: 17, xp: 13000, title: "Olympian" },
  { level: 18, xp: 15500, title: "Ascended" },
  { level: 19, xp: 18500, title: "Transcendent" },
  { level: 20, xp: 22000, title: "Godlike" },
  { level: 21, xp: 26000, title: "Immortal" },
  { level: 22, xp: 31000, title: "Eternal" },
  { level: 23, xp: 37000, title: "Cosmic" },
  { level: 24, xp: 44000, title: "Universal" },
  { level: 25, xp: 52000, title: "Infinite" },
  { level: 26, xp: 62000, title: "Supreme" },
  { level: 27, xp: 74000, title: "Absolute" },
  { level: 28, xp: 88000, title: "Omega" },
  { level: 29, xp: 105000, title: "Alpha" },
  { level: 30, xp: 125000, title: "Press Start Legend" },
];
