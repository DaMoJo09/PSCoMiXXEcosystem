...
const ENV_VARS: EnvVar[] = [
  ...
  { name: "EMERGENT_WEBHOOK_SECRET", required: false, description: "Legacy: webhook secret for the streaming platform (PSStreaming). Prefer PSSTREAMING_WEBHOOK_SECRET." },
  { name: "PSSTREAMING_API_URL", required: false, description: "PSStreaming base URL (defaults to https://psstreaming.com)" },
