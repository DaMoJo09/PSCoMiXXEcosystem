        ...
        <Card className="bg-zinc-950 border-white/20 p-4 sm:p-6">
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="signup" className="space-y-4 pt-4">
              ...
              {/*
                App Store compliance (Guideline 4.8): if we offer a third-party
                sign-in like Google, we must also offer Sign in with Apple. We
                don't yet have Apple Developer credentials, so on iOS native
                we hide Google entirely — email-only sign-in keeps us compliant
                without needing the Apple SSO backend wired up.
              */}
              {!isIOSApp() && (
                <>
