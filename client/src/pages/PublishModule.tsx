...
import { 
  ...
  Users, Eye, Heart, Settings, Upload, Monitor
} from "lucide-react";
            ...
            <div className="bg-zinc-900 border-4 border-zinc-800 p-6">
              <div className="flex items-start gap-6 flex-col md:flex-row">
                ...
                <div className="flex-1 py-2">
                  <h3 className="text-lg font-black mb-2">Get Seen Worldwide</h3>
                  <p className="text-sm text-zinc-400 mb-4 leading-relaxed">
                    When you publish, your content goes live on PS Streaming — the streaming platform for creator content. 
                    Readers can discover, read, and follow your work.
                  </p>
                  <div className="space-y-2 text-sm text-zinc-500">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>Reach the global community</span>
                    </div>
                  </div>
                  <a
                    ...
                    className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-cyan-500 text-black font-bold text-sm hover:bg-cyan-400 transition-colors"
                    data-testid="link-visit-streaming"
                  >
                    <Monitor className="w-4 h-4" /> Visit PS Streaming
                  </a>
                </div>
              </div>
            </div>
