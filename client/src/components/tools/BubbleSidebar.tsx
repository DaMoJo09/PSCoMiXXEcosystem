...
const SVG_DIALOG_BUBBLES: AssetItem[] = Array.from({ length: 100 }, (_, i) => {
  ...
  return {
    id: `dialog_${num}`,
    name: `Dialog ${i + 1}`,
    url: `/attached_assets/Comic%20style%20dialog-${num}.svg`,
  ...
  Array.from({ length: 68 }, (_, i) => {
    ...
    return {
      ...
      url: `/attached_assets/Comic%20style%20dialog%201-${num}.svg`,
      category: "bubble" as const,
      tags: ["speech", "dialogue", "comic", "svg"],
    };
  })
  ...
  return (
    <aside className="w-64 border-r border-zinc-800 bg-zinc-900 flex flex-col" data-testid="bubble-sidebar">
      <div className="p-3 border-b border-zinc-800 flex items-center justify-between">
        ...
        <button onClick={onClose} className="p-1 hover:bg-zinc-800 text-zinc-400 hover:text-white">
          <X className="w-4 h-4" />
        </button>
      </div>
