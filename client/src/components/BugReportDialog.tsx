  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-4 right-4 z-50 w-10 h-10 bg-zinc-800 border border-zinc-700 hover:bg-zinc-700 transition flex items-center justify-center group"
        title="Report Issue"
